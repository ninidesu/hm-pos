...
The function sends through the HM POS Gmail account. Use a dedicated
...
supabase secrets set MAIL_FROM_NAME="HM POS"
...
```bash
supabase secrets set STORE_NAME="HM POS"
...
For the currently linked HM POS project, do not run a blanket `supabase
