...
const STORAGE_PREFIX = 'hrm-pos:management-session:v1:'
export const MANAGEMENT_REFRESH_EVENT = 'hrm-pos:management-data-refresh'
...
export function clearManagementSessionState(scope) {
  ...
  Object.keys(window.sessionStorage)
    .filter((key) => key.startsWith(STORAGE_PREFIX) || key.startsWith('hrm-pos:management-scroll:'))
