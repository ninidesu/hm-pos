...
export default function AppShell({ role, title, eyebrow, children, actions, titleActions, onRefresh, onNotifications, notificationCount = 0 }) {
  ...
  useEffect(() => {
    const scrollKey = `hrm-pos:management-scroll:${pathname}`
  ...
  }, [role, staffPreferences.notify_low_stock, staffPreferences.notify_menu_changes, staffPreferences.notify_new_orders, user?.id])
